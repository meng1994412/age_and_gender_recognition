...
# define the type of dataset, either "gender" or "age"
DATASET_TYPE = "age"

# define the base paths to the faces dataset and output path
BASE_PATH = "/home/sunny/github/datasets/adience"
OUTPUT_BASE = "output"
MX_OUTPUT = BASE_PATH
...
# check to see if we are working with "age" portion of the dataset
if DATASET_TYPE == "age":
    # define the number of labels for the "age" dataset
    # along with the path to the label encoder
    NUM_CLASSES = 8
